  ...
  categories: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: "https://www.youtube.com/watch?v=def789",
          logo: "/assets/youtube.png",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: "https://www.facebook.com/groups/digitalmarketing",
          logo: "https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg",
        },
        {
          title: "Graphic Design Inspiration",
          link: "https://www.facebook.com/groups/graphicdesign",
          logo: "https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg",
        },
      ],
    },
      ...
      items: [
        {
          ...
          link: "https://t.me/reactjsdevs",
          logo: "https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg",
        },
        {
          title: "SEO Enthusiasts",
          link: "https://t.me/seoenthusiasts",
          logo: "https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg",
        },
        {
          title: "Frontend Web Development",
          link: "https://t.me/frontendwebdev",
          logo: "https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg",
        },
      ],
    },
          ...
          <div className="h-[79%] overflow-y-scroll pb-[30px]">
            ...
            >
              {jsonData.categories.map((category, i) => (
                <div
                  key={i}
                  className="w-full flex items-start flex-col px-[30px] gap-[15px]"
                >
                  <h2 className="text-xl mb-4">{category.category}</h2>
                  {category.items.map((item, j) => (
                    <motion.div
                      variants={itemVariants}
                      className="bg-[#071d2e] p-3 pl-5 box flex flex-row rounded-[10px] cursor-pointer w-[100%] gap-[10px] items-center"
                      key={j}
                      onClick={() => mineDrop()}
                    >
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <div className="text-white font-bold text-2xl mb-4 flex justify-center items-center gap-3 relative top-1">
                          <Image
                            src="/assets/coin.png"
                            alt="Points:"
                            width="30"
